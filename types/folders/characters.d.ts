declare module "@PaimonApp/genshin-db" {
	export interface Character {
		...
		associationType: 'ASSOC_FATUI' | 'ASSOC_FONTAINE' | 'ASSOC_HVISION' | 'ASSOC_INAZUMA' | 'ASSOC_LIYUE' | 'ASSOC_MAINACTOR' | 'ASSOC_MONDSTADT' | 'ASSOC_NATLAN' | 'ASSOC_NODKRAI' | 'ASSOC_NODKRAI_ZIBAI' | 'ASSOC_OMNI_SCOURGE' | 'ASSOC_RANGER' | 'ASSOC_SNEZHNAYA' | 'ASSOC_SNEZHNAYA_STAR' | 'ASSOC_SUMERU'; // enum;
